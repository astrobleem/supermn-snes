...
inext=$00D0F5
ce4_leaf=$00E8A2
entry_ce4_after_counter=$00E8A7
rdw40_l=$00E59E
wrw40_l=$00E5A2
rdb40_l=$00E5A6
wrb40_l=$00E5AA
...
h13be_exit_flags_ors=$99FC2C ; table/RTS return after captured MOVE.W CCR
h13be_store_flags_table=$99FC7B ; closing store + CCR capture before D1 restore
...
; Fixed-address byte-sized MOVE flag helper for $D3F6.  readbyte_l returns a
; zero-extended byte while 68000 MOVE.B derives N from bit 7.  The full helper
; lives in bank $95's guarded pre-$9FA0 slack; this fixed trampoline preserves
; every established flowing bank-$94 entry address.
    .org $B3E0
...
; ============================================================================
; Stage-3 object-state hot bodies.
;
; These table-convention entries are reached only after the original $02E42C
; dispatcher has selected a record state and left the caller's genuine return
; on the emulated 68000 stack.  Keeping the dispatcher interpreted preserves
; its MOVEM, final-record, CCR/X, and callback-stack contract.  The generated
; bodies retain per-basic-block $AC charging and observable call residue.
;
; >>> STAGE3_HOT_BODIES — generated by tools/gen_stage3_hot_bodies.py <<<
    .org $B600
.a16
.i16
; Reserved island $B600-$BBFF; source PC $027952.
; --- transpiled from $027952 (40 instrs) by tools/transpile.py [bank1] ---
entry_27952:
    rep #$30
    ; AOT-table/rts dispatch: caller return ALREADY on the 68K stack -> NO re-simulate push
    php
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE bsr.w $27aea -> direct guarded native child; resume br27952_1
    lda #br27952_1
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l $9FC000
br27952_1:
    ; restore real 68K call return residue below A7: $027956
    lda $3C
    sec
    sbc #$0004
    tax
...
Lf27952_3:
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE bsr.w $27aae -> ojmp_hook (callee --table escape, else interpret), resume br27952_2
    lda #br27952_2
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br27952_2:
    ; restore real 68K call return residue below A7: $027966
    lda $3C
    sec
    sbc #$0004
    tax
...
Lf27952_8:
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE bsr.w $27a80 -> ojmp_hook (callee --table escape, else interpret), resume br27952_3
    lda #br27952_3
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br27952_3:
    ; restore real 68K call return residue below A7: $0279A8
    lda $3C
    sec
    sbc #$0004
    tax
...
L27952_279c4:
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE jsr $2e524(pc) -> ojmp_hook (callee --table escape, else interpret), resume br27952_4
    lda #br27952_4
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br27952_4:
    ; restore real 68K call return residue below A7: $0279C8
    lda $3C
    sec
    sbc #$0004
    tax
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE bsr.w $27b44 -> ojmp_hook (callee --table escape, else interpret), resume br27952_5
    lda #br27952_5
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br27952_5:
    ; restore real 68K call return residue below A7: $0279CC
    lda $3C
    sec
    sbc #$0004
    tax
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE bsr.w $27b7c -> ojmp_hook (callee --table escape, else interpret), resume br27952_6
    lda #br27952_6
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br27952_6:
    ; restore real 68K call return residue below A7: $0279D0
    lda $3C
    sec
    sbc #$0004
    tax
...
.a16
.i16
; Reserved island $BC00-$C1FF; source PC $0279D2.
; --- transpiled from $0279D2 (41 instrs) by tools/transpile.py [bank1] ---
entry_279d2:
    rep #$30
    ; AOT-table/rts dispatch: caller return ALREADY on the 68K stack -> NO re-simulate push
    php
...
Lf279d2_2:
    ...
    lda #$0064
    sta $1C
    ; CALL-BRIDGE jsr $296f2(pc) -> ojmp_hook (callee --table escape, else interpret), resume br279d2_1
    lda #br279d2_1
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br279d2_1:
    ; restore real 68K call return residue below A7: $027A0A
    lda $3C
    sec
    sbc #$0004
    tax
...
Lf279d2_4:
    ...
    sta $00
    rep #$20
    ; CALL-BRIDGE jsr $2e5ba(pc) -> ojmp_hook (callee --table escape, else interpret), resume br279d2_2
    lda #br279d2_2
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br279d2_2:
    ; restore real 68K call return residue below A7: $027A26
    lda $3C
    sec
    sbc #$0004
    tax
    ...
    lda #$0001
    sta $1C
    ; CALL-BRIDGE jsr $296f2(pc) -> ojmp_hook (callee --table escape, else interpret), resume br279d2_3
    lda #br279d2_3
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br279d2_3:
    ; restore real 68K call return residue below A7: $027A38
    lda $3C
    sec
    sbc #$0004
    tax
...
L279d2_27a3a:
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE jsr $2e5f4(pc) -> ojmp_hook (callee --table escape, else interpret), resume br279d2_4
    lda #br279d2_4
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br279d2_4:
    ; restore real 68K call return residue below A7: $027A3E
    lda $3C
    sec
    sbc #$0004
    tax
...
L279d2_27a5c:
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE jsr $2e524(pc) -> ojmp_hook (callee --table escape, else interpret), resume br279d2_5
    lda #br279d2_5
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br279d2_5:
    ; restore real 68K call return residue below A7: $027A60
    lda $3C
    sec
    sbc #$0004
    tax
...
.a16
.i16
; Reserved island $C200-$D7FF; source PC $02F3BA.
; --- transpiled from $02F3BA (68 instrs) by tools/transpile.py [bank1] ---
entry_2f3ba:
    rep #$30
    ; AOT-table/rts dispatch: caller return ALREADY on the 68K stack -> NO re-simulate push
    php
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE jsr $2e676(pc) -> ojmp_hook (callee --table escape, else interpret), resume br2f3ba_1
    lda #br2f3ba_1
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br2f3ba_1:
    ; restore real 68K call return residue below A7: $02F3BE
    lda $3C
    sec
    sbc #$0004
    tax
...
Lf2f3ba_3:
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE jsr $29544(pc) -> ojmp_hook (callee --table escape, else interpret), resume br2f3ba_2
    lda #br2f3ba_2
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br2f3ba_2:
    ; restore real 68K call return residue below A7: $02F3CE
    lda $3C
    sec
    sbc #$0004
    tax
...
Lf2f3ba_8:
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE jsr $29510(pc) -> ojmp_hook (callee --table escape, else interpret), resume br2f3ba_3
    lda #br2f3ba_3
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br2f3ba_3:
    ; restore real 68K call return residue below A7: $02F410
    lda $3C
    sec
    sbc #$0004
    tax
...
L2f3ba_2f464:
    ...
    sta $400000,x
    xba
    ; CALL-BRIDGE bsr.w $2f542 -> ojmp_hook (callee --table escape, else interpret), resume br2f3ba_4
    lda #br2f3ba_4
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br2f3ba_4:
    ; restore real 68K call return residue below A7: $02F478
    lda $3C
    sec
    sbc #$0004
    tax
...
L2f3ba_2f488:
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE jsr $2e4b8(pc) -> ojmp_hook (callee --table escape, else interpret), resume br2f3ba_5
    lda #br2f3ba_5
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br2f3ba_5:
    ; restore real 68K call return residue below A7: $02F48C
    lda $3C
    sec
    sbc #$0004
    tax
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE bsr.w $2f56a -> ojmp_hook (callee --table escape, else interpret), resume br2f3ba_6
    lda #br2f3ba_6
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br2f3ba_6:
    ; restore real 68K call return residue below A7: $02F490
    lda $3C
    sec
    sbc #$0004
    tax
    ...
    jsr esc_ac_charge
    plp
    ; CALL-BRIDGE bsr.w $2f5a2 -> ojmp_hook (callee --table escape, else interpret), resume br2f3ba_7
    lda #br2f3ba_7
    sta $54
    lda #$00FD
    sta $56
    ...
    jml.l ojmp_hook
br2f3ba_7:
    ; restore real 68K call return residue below A7: $02F494
    lda $3C
    sec
    sbc #$0004
    tax
...
.a16
.i16
; Reserved island $CB40-$CCFF; source PC $027B44.
; Guarded hand-exact wrapper; shared direct emitter is fixed at $9F:E800.
; --- transpiled from $027B44 (16 instrs) by tools/gen_stage3_hot_bodies.py [hand-exact] ---
entry_27b44:
    rep #$30
    lda #$000E
    sta $80
...
.a16
.i16
; Reserved island $CD00-$CEBF; source PC $02F56A.
; Guarded hand-exact wrapper; shared direct emitter is fixed at $9F:E800.
; --- transpiled from $02F56A (16 instrs) by tools/gen_stage3_hot_bodies.py [hand-exact] ---
entry_2f56a:
    rep #$30
    lda #$0030
    sta $80
...
.a16
.i16
; Reserved island $CEC0-$D0FF; source PC $027B7C.
; Guarded hand-exact wrapper; shared direct emitter is fixed at $9F:E900.
; --- transpiled from $027B7C (20 instrs) by tools/gen_stage3_hot_bodies.py [hand-exact] ---
entry_27b7c:
    rep #$30
    lda #$0018
    sta $80
...
.a16
.i16
; Reserved island $D100-$D33F; source PC $02F5A2.
; Guarded hand-exact wrapper; shared direct emitter is fixed at $9F:E900.
; --- transpiled from $02F5A2 (20 instrs) by tools/gen_stage3_hot_bodies.py [hand-exact] ---
entry_2f5a2:
    rep #$30
    lda #$0034
    sta $80
...
.a16
.i16
; Reserved island $D340-$D47F; source PC $02E49C.
...
.a16
.i16
; Reserved island $D480-$D5FF; source PC $0296C6.
...
.a16
.i16
; Reserved island $D540-$D6FF; source PC $02E40E.
...
.a16
.i16
; Reserved island $DB20-$DFFF; source PC $0135E0.
...
; ============================================================================
; hce4_leaf_residue — bridge the jsr(An) shortcut to the exact CE4 renderer.
;
; jsrabs_hook2 enters the old bank-$00 leaf with A7 still pointing at the
; fourteen-byte argument block: the native hit skipped the caller's four-byte
; JSR push.  Recreate that one return, charge the otherwise skipped CE4 fetch,
; and enter hce4_entry using its already-validated table convention.
; hce4_entry then owns LINK/MOVEM residue, D/A state, CCR/X, work writes, the
; diagnostic counter, and consuming the synthesized return.  This replaces
; the older hand leaf, which matched visible output but omitted observable
; stack residue and final CCR/X.
; ============================================================================
    .org $CA00
.a16
.i16
hce4_leaf_residue:
    ...
    lda $AC
    dec a
    bne hce4_leaf_ac_ready
    inc a
hce4_leaf_ac_ready:
    sta $AC

    ; A7 -= 4; [A7] = the real 68000 return held by jsrabs_hook2.
    lda $3C
    sec
    sbc #$0004
    sta $3C
...
; Count CE4's original dynamic 68000 path without changing its source,
; renderer scratch, emulated registers, or CCR/X.  The guarded caller has
; already bounded the source to at most 32x32 words and capacity to 510.
;
; Private interpreter scratch:
;   $AE count, $B0-$B2 source, $B4 outer, $B6 inner initial,
;   $B8 d1, $BA initial d3, $BC d7, $BE tile,
;   $C0 inner running, $C2 d3 running.
hce4_ac_charge_exact:
    rep #$30

    ; Everything after the first LINK through the initial SUB.W: 17
    ; instructions.  The fetch choke has already charged LINK; the jsr(An)
    ; bridge above explicitly supplies that same one charge.
    lda #$0011
    sta $AE
    lda $80
    sta $B0
...
hca_outer:
    ...
    lda $B8
    eor #$8000
    cmp #$80FA                 ; signed d1 >= 250
    bcs hca_clamp_done

    ; CMPI #-6 / BLE, plus MOVE d1,d5 only for -5..249.
    lda #$0002
    jsr hca_add
    lda $B8
    eor #$8000
    cmp #$7FFB                 ; signed d1 >= -5
    bcc hca_clamp_done
    inc $AE
hca_clamp_done:
    ; MOVE d2 / MOVE d3 / ADDI #0,d3.
    lda #$0003
    jsr hca_add
    lda $B6
    sta $C0
...
hca_inner:
    ...
    adc #$0002
    sta $B0
    bcc hca_source_ready
    inc $B2
hca_source_ready:
    lda $BE
    beq hca_after_tile

    ; CMPI #-16 / BLE always execute for a live tile.
    lda #$0002
    jsr hca_add
    lda $C2
    eor #$8000
    cmp #$7FF1                 ; signed d3 >= -15
    bcc hca_hidden

    ; CMPI #$180 / BLT for values above -16.
    lda #$0002
    jsr hca_add
    lda $C2
    eor #$8000
    cmp #$8180                 ; signed d3 < $180
    bcc hca_visible
hca_hidden:
    ; MOVE #$FA,(a4)+ / BRA.
    lda #$0002
    jsr hca_add
    bra hca_position_done
hca_visible:
    ; MOVE d5,(a4)+.
    inc $AE
hca_position_done:
    ; ADDI tile / three MOVEs / ANDI / OR / SUBQ d7 / BLT.
    lda #$0008
    jsr hca_add
    dec $BC
    lda $BC
...
hca_rows_done:
    ; TST d7 / BLT, MOVE #$FA,d0, then (MOVE/DBRA)*(d7+1).
    lda #$0003
    jsr hca_add
    lda $BC
    inc a
...
hca_exhausted:
    ; A live tile exhausted d7 at SUBQ/BLT; no row tail or fill loop.
hca_epilogue:
    ; MOVEM.W / MOVEM.L / UNLK / RTS.
    lda #$0004
    jsr hca_add
    lda $AE
    jsr esc_ac_charge
...
; Keep the call site size-neutral in the packed bank-$94 CE4 body.  The JSR
; return remains on the native stack while bank $9F either jumps back to the
; RTS below after an exact 2x2 charge or tail-enters hce4_ac_charge_exact.
hce4_ac_charge_dispatch:
    jml.l $9FE700
hce4_ac_charge_fast_return:
    rts

hce4_leaf_residue_end:
...
xd_sparse_bank0:
    ...
    cmp #$0076
    bcc xd_table
    ; Admit pages $78-$7A as harmless sparse scans too.  Bank $9F rejects
    ; page $78 and every non-$79FE/$7AC6 PC before the generic table miss.
    cmp #$007B
...
xlat_choke:
    ...
    cmp #$0CE4
    beq xc_ce4
    cmp #$2D8A           ; copied C-Chip queue gateway, pinned in bank $95
    bne xc_dec
    jml.l $9599F0
xc_ce4:
    ...
    inc a
    sta $407FE0
    jml.l xlat_dispatch  ; $94F900 (guaranteed HIT -> push+RTL dispatches entry_ce4t, bit-exact)
xc_dec:
    jml.l $008102        ; nolog: decode the already-fetched opcode (bank $00)
xlat_choke_end:
...
hce4_guards_done:
    ; Charge the exact number of original 68000 instructions after CE4's
    ; already-accounted LINK fetch.  Stage 3 overwhelmingly uses a guarded,
    ; fully visible 2x2/capacity-four class whose count is invariant; let the
    ; bank-$9F helper charge that exact closed form without walking the same
    ; four cells twice.  Every miss tail-enters the original bounded counter.
    jsr hce4_ac_charge_dispatch
...
hce4_counter:
    ...
    ; The early exact-charge guard retained all four words for Stage 3's
    ; dominant fully-visible 2x2 class.  Bypass the second shape-dispatch
    ; preflight and its four duplicate source reads, while keeping the common
    ; LINK/MOVEM image, pointers, registers, AC charge, and return epilogue.
    lda $6A
    beq hce4_shape_dispatch
    jsl.l $9FD200
    jmp hce4_hot_done
hce4_shape_dispatch:
