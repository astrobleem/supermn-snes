...
with McpSession(rom='/home/chad/supermn-snes/build/interp.sfc',mesen=NEXEN,port=7533,boot_wait=6.0,socket_timeout=300.0) as m:
    ...
    w16(0xAC,0x2F60); w16(0x0718,0xFFF8); w16(0x071A,ESC)
