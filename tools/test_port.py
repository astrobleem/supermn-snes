#!/usr/bin/env python3
"""Test the Superman port ROM in Mesen-MCP."""
...
with McpSession(rom=rom_path, mesen=mesen_exe, port=7337, boot_wait=3.0) as m:
    ...
    print()
    print("Superman port ROM running in Mesen-MCP!")
