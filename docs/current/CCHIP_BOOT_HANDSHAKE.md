...
via `trace_cchip_superman`). **This corrects
[CCHIP_FIRMWARE.md](CCHIP_FIRMWARE.md) "PORT RESOLUTION" point 3**
("nothing gameplay-critical consumes a C-Chip value") — boot *does*
