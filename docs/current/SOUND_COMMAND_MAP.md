...
command-id → musical-cue → TAD-track table that P2 wiring routes through. See the
[current VGM-to-TAD pipeline](../toolchain/SOUND_PIPELINE.md) and
[historical sound bootstrap handoff](../history/audio/SOUND_BOOTSTRAP_HANDOFF.md) for
