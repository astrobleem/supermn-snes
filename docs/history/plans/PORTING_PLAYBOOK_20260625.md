...
> **Historical playbook (June 25, 2026).** The hard-earned method and rejected ideas
> remain useful, but tool names, status, and Gigandes specifics have since been
> reconciled in the [reusable toolchain guide](../../toolchain/README.md) and
> [Gigandes onboarding](../../gigandes/README.md).
...
(`docs/toolchain/GRAPHICS_PALETTE_EVIDENCE.md`, `docs/history/designs/TRANSPILER_DESIGN.md`, `docs/history/experiments/INTERPRETER_BRINGUP.md`,
`docs/history/plans/TRANSPILER_TOOL_SCOPE.md`, `docs/toolchain/TRACE_COVERAGE.md`) and `STATUS.md`/`ROADMAP.md`.
...
`docs/toolchain/DEBUGGING.md` — the interpreter's diagnostic-build debug interface (PC-ring
...
paths reproduced (foreground→OBJ, playfield→BG), 47/47 colors. See `docs/toolchain/GRAPHICS_PALETTE_EVIDENCE.md`.
...
### 2a. Settle the semantics first (`docs/history/designs/TRANSPILER_DESIGN.md`)
...
as a current total. See `docs/history/campaigns/MAIN_PLANNING_HANDOFF.md` for the authoritative current set.)*
See `docs/history/plans/TRANSPILER_TOOL_SCOPE.md` + the `transpiler-tool`/`bulk-transpile-phase` memories.
...
See `docs/history/campaigns/MAIN_PLANNING_HANDOFF.md` (authoritative).
...
35,047 descent blocks. See `docs/toolchain/TRACE_COVERAGE.md`.
