# Historical object-processor campaign — `$01Cxxx` A1/A2/A3

> **Historical design record (July 3, 2026).** This document preserves the A1/A2
> implementation and A3 planning state. Its “next session,” scratch paths, overlap
> expectations, and cost rankings are not current instructions. Use
> [current status](../../current/STATUS.md), the
> [transpiler workflow](../../toolchain/TRANSPILER_WORKFLOW.md), and the current source
> before acting on it.
