...
> **Early historical reference.** It contains known digit-dropped addresses and
> pre-interpreter assumptions. Do not use it as an implementation map. Start with the
> [current architecture](../../current/ARCHITECTURE.md) and
> [address-map guide](../../toolchain/ADDRESS_MAP_ADAPTATION.md).
...
### Disassembly Status (updated June 17, 2026 — see `docs/toolchain/TRACE_COVERAGE.md`)
