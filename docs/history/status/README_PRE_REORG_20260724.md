...
> **Archived root README.** This is the complete pre-reorganization entry point,
> preserved so none of its status archaeology or handoff detail is lost. It is not
> current onboarding. Use the short [root README](../../../README.md) and
...
> candidate, not playable or shippable**. See [RECOVERY.md](../../../docs/history/recovery/RECOVERY.md) R15,
> [the focused handoff](../../../docs/history/handoffs/V135_IRAM_FREEZE_HUD_AUDIO_20260724.md), and
> [CONFESSION.md](../../../docs/history/recovery/CONFESSION.md).
>
...
| **Bulk game-logic port** | ⬆ **underway (automated)** — **~25 escapes deployed** (18 in the SA-1 escape bank + bank-$00 gaps), covering **~40%** of the real per-frame work; incl. the ~12.6% collision (bridged) and ~5.9% video. *(Phase snapshot — these counts conflate "deployed in the bank" with "actually fires in gameplay" and are superseded by [docs/history/campaigns/MAIN_PLANNING_HANDOFF.md](../../../docs/history/campaigns/MAIN_PLANNING_HANDOFF.md); the live bottleneck is the coroutine scheduler + handler chains, not dispatch coverage.)* |
...
See **[CONFESSION.md](../../../docs/history/recovery/CONFESSION.md)** for the authoritative correction and
**[RECOVERY.md](../../../docs/history/recovery/RECOVERY.md)** for the active recovery campaign. `STATUS.md` and
...
**[docs/history/experiments/INTERPRETER_BRINGUP.md](../../../docs/history/experiments/INTERPRETER_BRINGUP.md)** and **[docs/history/plans/TRANSPILER_TOOL_SCOPE.md](../../../docs/history/plans/TRANSPILER_TOOL_SCOPE.md)**.

## Key documents

- **[CONFESSION.md](../../../docs/history/recovery/CONFESSION.md)** — highest-authority correction to project status
- **[RECOVERY.md](../../../docs/history/recovery/RECOVERY.md)** — active consolidation and baseline campaign
- **[docs/history/performance/PROFILE_CAMPAIGN.md](../../../docs/history/performance/PROFILE_CAMPAIGN.md)** — native/render campaign and historical
  R6 timing evidence
- **[docs/history/handoffs/V135_IRAM_FREEZE_HUD_AUDIO_20260724.md](../../../docs/history/handoffs/V135_IRAM_FREEZE_HUD_AUDIO_20260724.md)**
  — exact v135 IRAM-erasure diagnosis/repair, restored top HUD, audio provenance, and evidence limits
- **[docs/history/handoffs/V134_STAGE2_VERTICAL_SCROLL_20260724.md](../../../docs/history/handoffs/V134_STAGE2_VERTICAL_SCROLL_20260724.md)**
  — historical exact-v134 vertical-scroll bridge, MAME/Nexen/Mesen evidence, and approximation
- **[docs/history/handoffs/V133_TITLE_ATTRACT_BOOT_20260723.md](../../../docs/history/handoffs/V133_TITLE_ATTRACT_BOOT_20260723.md)**
  — historical exact-v133 title-register, idle-attract, credit-label, and non-rotating zoom evidence
- **[docs/history/handoffs/V132_TITLE_CRATE_RIGHT_EDGE_20260723.md](../../../docs/history/handoffs/V132_TITLE_CRATE_RIGHT_EDGE_20260723.md)**
  — historical exact-v132 title-capacity, crate-continuation, wrapped-right, and rejection context
- **[docs/history/handoffs/V130_SECOND_PLAYTEST_20260723.md](../../../docs/history/handoffs/V130_SECOND_PLAYTEST_20260723.md)**
  — historical exact-v131 static-logo, initial centered-crop, displayed-cache, and rejection context
- **[docs/history/handoffs/FIRST_WALL_OCTAVE_AUDIO_AND_BOOT_20260723.md](../../../docs/history/handoffs/FIRST_WALL_OCTAVE_AUDIO_AND_BOOT_20260723.md)**
  — historical exact-v130 wall-context, octave-audio, rotating Mode 7 boot, and cold-boot evidence
- **[docs/history/handoffs/MESEN211_PLAYTEST_REGRESSIONS_20260723.md](../../../docs/history/handoffs/MESEN211_PLAYTEST_REGRESSIONS_20260723.md)**
  — historical v128 exact-Mesen title/transition/audio/charge evidence and residual render-debt verdict
- **[docs/history/performance/R5_SCHEDULER_EXPERIMENTS.md](../../../docs/history/performance/R5_SCHEDULER_EXPERIMENTS.md)** — historical
  continuous profile and the two rejected pre-R6 pacing labs
- **[STATUS.md](../../../docs/history/status/STATUS_THROUGH_20260724.md)** — detailed historical state (superseded where noted)
- **[ROADMAP.md](../../../docs/history/plans/ROADMAP.md)** — next steps and milestones
- **[BUILD.md](../../../docs/current/BUILDING.md)** — toolchain (the "Game Garden" suite: Poppy/Peony), dependencies, and **migration guide**
- **[docs/current/ROM_INPUTS.md](../../../docs/current/ROM_INPUTS.md)** — authenticated ROM-set preparation,
  exact private-output hashes, dry-run/validation modes, and legal boundary
- **[docs/history/handoffs/ROM_PREPARATION_TOOL_20260724.md](../../../docs/history/handoffs/ROM_PREPARATION_TOOL_20260724.md)**
  — byte-identity, synthetic-test, fresh-tree build, and remaining-input report
- **[docs/history/plans/PORTING_PLAYBOOK_20260625.md](../../../docs/history/plans/PORTING_PLAYBOOK_20260625.md)** — the reusable arcade→SNES recipe
- **[docs/history/designs/TRANSPILER_DESIGN.md](../../../docs/history/designs/TRANSPILER_DESIGN.md)** — 68K→SA-1 lowering decisions
- **[docs/history/experiments/INTERPRETER_BRINGUP.md](../../../docs/history/experiments/INTERPRETER_BRINGUP.md)** — interpreter design & validation
- **[docs/toolchain/GRAPHICS_PALETTE_EVIDENCE.md](../../../docs/toolchain/GRAPHICS_PALETTE_EVIDENCE.md)** — graphics path validation
- **[CCHIP_BOOT_HANDSHAKE.md](../../../docs/current/CCHIP_BOOT_HANDSHAKE.md)** / **[CCHIP_FIRMWARE.md](../../../docs/current/CCHIP_FIRMWARE.md)** — C-Chip resolution
...
1. Authenticate the supported World set and generate the reproducible private inputs:
   ...
   `--validate-only`. See [docs/current/ROM_INPUTS.md](../../../docs/current/ROM_INPUTS.md). The exact FM
...
- **Canonical branch**: `main` (= the `recovery/canonicalize-20260712` line). Canonical
  ...
  [RECOVERY.md](../../../docs/history/recovery/RECOVERY.md)). Pre-recovery tips are preserved as local `archive/*` refs.
...
- **Oracles**: MAME 0.287 (arcade) and the MCP-enabled Nexen fork (SNES/SA-1/PPU).
  Emulator-harness tribal knowledge: [docs/toolchain/DEBUGGING.md](../../../docs/toolchain/DEBUGGING.md)
...
- **30/60 fps is out of reach for this architecture** — R5's verdict
  ([docs/history/performance/R5_SCHEDULER_EXPERIMENTS.md](../../../docs/history/performance/R5_SCHEDULER_EXPERIMENTS.md)): the idle
...
see [docs/history/plans/PORTING_PLAYBOOK_20260625.md](../../../docs/history/plans/PORTING_PLAYBOOK_20260625.md) for the reusable recipe and the gotchas doc for
