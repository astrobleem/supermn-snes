...
> **Archived agent guide.** Its detailed July 24 evidence accounting is preserved,
> but its document-precedence and path instructions were replaced by the current
...
3. The newest branch/worktree-specific handoff and evidence (`docs/history/performance/PROFILE_CAMPAIGN.md`,
   `docs/history/campaigns/MAIN_PLANNING_HANDOFF.md`, `docs/history/audio/SOUND_BOOTSTRAP_HANDOFF.md`, and focused `docs/history/handoffs/*`).
...
Before changing code, also read `BUILD.md`, `docs/history/plans/PORTING_PLAYBOOK_20260625.md`, `tools/README.md`, and the focused
design document for the subsystem being touched. The interpreter debugging reference is
`docs/toolchain/DEBUGGING.md`.
...
see `docs/current/ROM_INPUTS.md`. Never substitute placeholder FM samples and call the result
equivalent.
