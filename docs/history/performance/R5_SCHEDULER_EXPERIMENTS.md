...
> **Historical negative-result record.** The rejected scheduler experiments below
> remain essential evidence, but current performance and candidate truth live in
...
> `docs/history/performance/PROFILE_CAMPAIGN.md`. Do not use the R5 table below to describe v105.
