...
> **Historical performance ledger.** Retain its measurements and failed assumptions,
> but do not resume its ranked work or use its old 60 Hz/179K target. The current
> contract and latest formal result are in
> [current status](../../current/STATUS.md) and
> [scheduler/timing](../../toolchain/SCHEDULER_TIMING.md).
...
**Full spec: `docs/history/designs/OBJECT_PROCESSOR_CAMPAIGN_20260703.md`.** The "un-escapable dynamic coroutine" verdict is SOFT: one
...
Related: `legacy memory: scheduler-switchin-shipped`, `legacy memory: bulk-transpile-phase`, `legacy memory: escape-deploy-shift-safe`.
...
byte delta.** See `legacy memory: coroutine-bridge-retarget-derails`.
...
`docs/history/handoffs/CHARGED_SHOT_FREEZE_20260723.md` and `RECOVERY.md` R8.
...
`docs/history/handoffs/MESEN211_PLAYTEST_REGRESSIONS_20260723.md` and `RECOVERY.md` R9.
...
evidence is in `docs/history/handoffs/FIRST_WALL_OCTAVE_AUDIO_AND_BOOT_20260723.md` and `RECOVERY.md` R10.
...
`docs/history/handoffs/V130_SECOND_PLAYTEST_20260723.md` and `RECOVERY.md` R11.
...
in `docs/history/handoffs/V135_IRAM_FREEZE_HUD_AUDIO_20260724.md` and `RECOVERY.md` R15.
