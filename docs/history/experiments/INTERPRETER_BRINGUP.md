...
> [ROADMAP.md](../plans/ROADMAP.md) → Known limitations). The notes below are the original
> spike record.
...
3. **Executes** them (68K regs in direct page per `docs/history/designs/TRANSPILER_DESIGN.md` D2;
