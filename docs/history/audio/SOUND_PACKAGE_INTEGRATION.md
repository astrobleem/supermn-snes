...
```
docs/history/audio/SOUND_BOOTSTRAP_HANDOFF.md                      ← READ FIRST: the TAD bring-up runbook for Superman
...
`.claude/skills/vgm-to-tad-mml/`, `docs/history/audio/SOUND_BOOTSTRAP_HANDOFF.md`, and `INTEGRATION.md` into place.
...
`docs/history/audio/SOUND_BOOTSTRAP_HANDOFF.md` §8).
...
pass. Each track's `notes.md` lists exactly what to fill in, and `docs/history/audio/SOUND_BOOTSTRAP_HANDOFF.md` is the
end-to-end runbook (vendor TAD → build instruments → hand-tune → compile → integrate).

## Next step

Open `docs/history/audio/SOUND_BOOTSTRAP_HANDOFF.md` and follow the Quick-start checklist, starting with **03 Main
BGM 1**.
