...
> **Historical correction ledger, not the current status authority.** Its failures and
> corrections remain evidence. The reconciled present-tense verdict now lives only in
...
`docs/history/handoffs/V135_IRAM_FREEZE_HUD_AUDIO_20260724.md` and `RECOVERY.md` R15.
...
known audio defects remain untouched. See `docs/history/handoffs/CHARGED_SHOT_FREEZE_20260723.md` and
`RECOVERY.md` R8.
...
`RECOVERY.md` R6 and `docs/history/performance/PROFILE_CAMPAIGN.md`.
...
and `docs/history/performance/R5_SCHEDULER_EXPERIMENTS.md`. The sound and production-clamp warnings below remain.
...
- The **methodology docs** (`docs/history/plans/PORTING_PLAYBOOK_20260625.md`, `tools/README.md`, `BUILD.md`,
  `docs/toolchain/DEBUGGING.md`) are accurate about *process and tooling*, even where
