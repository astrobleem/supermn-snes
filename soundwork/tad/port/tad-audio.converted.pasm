...
segment "BSS"
    ...
    TadPrivate_dataToTransfer_addr: fill 2, $00
    TadPrivate_dataToTransfer_bank: fill 1, $00

    ;; The remaining number of bytes to transfer
    TadPrivate_dataToTransfer_size: fill 2, $00

    ;; The previous value written to the loader spinLock
    TadPrivate_dataToTransfer_prevSpinLock: fill 1, $00
...
segment "BSS"
    ...
    TadPrivate_nextCommand_id: fill 1, $00

    ;; The two parameters of the next command (if any)
    TadPrivate_nextCommand_parameter0: fill 1, $00
    TadPrivate_nextCommand_parameter1: fill 1, $00
...
segment "ZEROPAGE"
    ;; see tad-audio.inc
    Tad_sfxQueue_sfx: fill 1, $00
    Tad_sfxQueue_pan: fill 1, $00
