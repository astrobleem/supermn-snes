...
# Integration config: state at $00:1F00 (WRAM mirror), sfx-queue DP $68, internal jsl forced to bank $E9.
...
TAD_BSS_BASE=0x1F00 TAD_ZP_BASE=0x68 TAD_CODE_BANK=0xE9 python3 port_tad.py
