# Attract Mode — vgm2mml conversion notes

- Source VGM: `01 Attract Mode.vgm`
- Chip: YM2610B @ 8000000 Hz
- Duration: 16.08s; loop start 0.00s (tick 0); loop length 0.00s
- Tempo: **118 BPM**, auto-detected (mean grid error 0.211 tick); candidates [76, 96, 152]
...
|-----------|-----------|------:|-----:|-----------|
| @10 sm_drum_060000 | 0x060000-0x0629FF | 10752 | 51 | [5] |
| @11 sm_drum_065200 | 0x065200-0x0677FF | 9728 | 4 | [5] |
