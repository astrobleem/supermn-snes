# Round 5-1 — vgm2mml conversion notes

- Source VGM: `13 Round 5-1.vgm`
- Chip: YM2610B @ 8000000 Hz
- Duration: 24.59s; loop start 0.69s (tick 66); loop length 23.90s
- Tempo: **114 BPM**, auto-detected (mean grid error 0.218 tick); candidates [152, 114, 92]
...
|----|--------|-----------:|---------|-----------------|
| A | FM0 | 48 | 2-5 | fm_p41 |
| B | FM1 | 145 | 5-6 | fm_p30 |
| C | FM2 | 47 | 2-5 | fm_p41 |
| D | FM3 | 143 | 4-4 | fm_p44 |
| E | ADPCM-A ch5 | 11 | 4-4 | (drum kit, see below) |
...
|-----------|-----------|------:|-----:|-----------|
| @10 sm_drum_079a00 | 0x079A00-0x07B4FF | 6912 | 11 | [5] |
