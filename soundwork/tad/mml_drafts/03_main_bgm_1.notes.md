# Main BGM 1 — vgm2mml conversion notes

- Source VGM: `03 Main BGM 1.vgm`
- Chip: YM2610B @ 8000000 Hz
- Duration: 99.07s; loop start 8.65s (tick 900); loop length 90.42s
- Tempo: **130 BPM**, auto-detected (mean grid error 0.237 tick); candidates [90, 170, 93]
...
|----|--------|-----------:|---------|-----------------|
| A | FM0 | 420 | 2-5 | sm_fm0 |
| B | FM1 | 383 | 3-6 | sm_fm1 |
| C | FM2 | 669 | 3-7 | sm_fm2 |
| D | FM3 | 485 | 2-7 | sm_fm3 |
...
| @13 sm_drum_067800 | 0x067800-0x069EFF | 9984 | 32 | [5] |
...
| @17 sm_drum_079a00 | 0x079A00-0x07B4FF | 6912 | 48 | [4, 5] |
