# Name Entry — vgm2mml conversion notes

- Source VGM: `20 Name Entry.vgm`
- Chip: YM2610B @ 8000000 Hz
- Duration: 16.05s; loop start 0.82s (tick 78); loop length 15.23s
- Tempo: **116 BPM**, auto-detected (mean grid error 0.199 tick); candidates [116, 163, 152]
...
| C | FM2 | 64 | 4-5 | fm_p30 |
| D | FM3 | 20 | 2-3 | fm_p56 |
| E | ADPCM-A ch5 | 13 | 4-4 | (drum kit, see below) |
...
|-----------|-----------|------:|-----:|-----------|
| @10 sm_drum_062a00 | 0x062A00-0x0651FF | 10240 | 8 | [5] |
| @11 sm_drum_067800 | 0x067800-0x069EFF | 9984 | 1 | [5] |
