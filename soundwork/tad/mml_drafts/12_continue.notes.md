# Continue — vgm2mml conversion notes

- Source VGM: `12 Continue.vgm`
- Chip: YM2610B @ 8000000 Hz
- Duration: 13.32s; loop start 0.00s (tick 0); loop length 0.00s
- Tempo: **111 BPM**, auto-detected (mean grid error 0.219 tick); candidates [152, 111, 150]
...
| C | FM2 | 57 | 3-4 | fm_p08 |
| D | FM3 | 37 | 2-4 | fm_p42 |
| E | ADPCM-A ch5 | 51 | 4-4 | (drum kit, see below) |
...
|-----------|-----------|------:|-----:|-----------|
| @10 sm_drum_069f00 | 0x069F00-0x06C4FF | 9728 | 51 | [5] |
