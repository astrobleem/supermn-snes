...
Companion docs: `RISK_TRANSPILER.md` (hazard analysis + gates), `PALETTE_VERDICT.md`
...
- **Byte / packed-pixel arrays:** no swap. (gfx tiles are handled by the asset
  pipeline, not here — see `PALETTE_VERDICT.md`.)
...
hardware-validated graphics path (`PALETTE_VERDICT.md`).
