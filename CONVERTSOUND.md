# CONVERTSOUND.md — Superman Arcade VGMRips Conversion Notes
...
The earlier `SOUNDHARDWARE.md` focuses on the arcade hardware and treats the chip as YM2610 OPNB. The VGMRips pack page says YM2610B. For conversion work, check the VGM header in every file:
...
If no YM2610 data blocks are found, use the arcade ROM sample file identified in `SOUNDHARDWARE.md` as the likely sample ROM source and trace playback from MAME instead.
